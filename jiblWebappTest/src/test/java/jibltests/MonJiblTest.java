...
/**
 * Vérifié: avec junit, version 4.12, Pour qu'une méthode soit exécutée en tant que test, il faut et il suffit:
 * 
 *  i - que la classe à laquelle elle appartient, ait un nom correspondant au design pattern définit dans la configuration du [maven-surefire-plugin].
 *      Par défaut, les noms des classes de tests doivent se terminer par la chaîne de caractères "Test".
